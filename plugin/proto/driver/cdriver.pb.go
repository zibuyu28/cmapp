...
type Nodes_Node_StateE int32

const (
	Nodes_Node_Handling Nodes_Node_StateE = 0
	Nodes_Node_Normal   Nodes_Node_StateE = 1
	Nodes_Node_Abnormal Nodes_Node_StateE = 2
)

// Enum value maps for Nodes_Node_StateE.
var (
	Nodes_Node_StateE_name = map[int32]string{
		0: "Handling",
		1: "Normal",
		2: "Abnormal",
	}
	Nodes_Node_StateE_value = map[string]int32{
		"Handling": 0,
		"Normal":   1,
		"Abnormal": 2,
	}
...
func (x Nodes_Node_StateE) Enum() *Nodes_Node_StateE {
	p := new(Nodes_Node_StateE)
	*p = x
	return p
}

func (x Nodes_Node_StateE) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Nodes_Node_StateE) Descriptor() protoreflect.EnumDescriptor {
	return file_cdriver_proto_enumTypes[0].Descriptor()
}

func (Nodes_Node_StateE) Type() protoreflect.EnumType {
	return &file_cdriver_proto_enumTypes[0]
}

func (x Nodes_Node_StateE) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Nodes_Node_StateE.Descriptor instead.
func (Nodes_Node_StateE) EnumDescriptor() ([]byte, []int) {
	return file_cdriver_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
type Nodes struct {
	...
	Nodes []*Nodes_Node `protobuf:"bytes,1,rep,name=Nodes,proto3" json:"Nodes,omitempty"`
}
...
func (x *Nodes) GetNodes() []*Nodes_Node {
	if x != nil {
		return x.Nodes
	}
	return nil
...
type Nodes_Node struct {
	...
	UUID       string            `protobuf:"bytes,2,opt,name=UUID,proto3" json:"UUID,omitempty"`
	Type       string            `protobuf:"bytes,3,opt,name=type,proto3" json:"type,omitempty"`
	State      Nodes_Node_StateE `protobuf:"varint,5,opt,name=State,proto3,enum=driver.Nodes_Node_StateE" json:"State,omitempty"` // 1处理中，2正常，3异常
...
func (x *Nodes_Node) Reset() {
	*x = Nodes_Node{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cdriver_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Nodes_Node) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Nodes_Node) ProtoMessage() {}

func (x *Nodes_Node) ProtoReflect() protoreflect.Message {
	mi := &file_cdriver_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Nodes_Node.ProtoReflect.Descriptor instead.
func (*Nodes_Node) Descriptor() ([]byte, []int) {
	return file_cdriver_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Nodes_Node) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Nodes_Node) GetUUID() string {
	if x != nil {
		return x.UUID
	}
	return ""
...
func (x *Nodes_Node) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *Nodes_Node) GetState() Nodes_Node_StateE {
	if x != nil {
		return x.State
	}
	return Nodes_Node_Handling
}

func (x *Nodes_Node) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *Nodes_Node) GetMachineID() int32 {
	if x != nil {
		return x.MachineID
	}
	return 0
...
func (x *Nodes_Node) GetChainID() int32 {
	if x != nil {
		return x.ChainID
	}
	return 0
...
func (x *Nodes_Node) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *Nodes_Node) GetCustomInfo() map[string]string {
	if x != nil {
		return x.CustomInfo
	}
	return nil
...
var file_cdriver_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x08, 0x41, 0x62, 0x6e, 0x6f, 0x72, 0x6d, 0x61, 0x6c, 0x10, 0x02, 0x22, 0xe9, 0x02, 0x0a, 0x05,
	...
	,
	...
	0x69, 0x6e, 0x1a, 0x0d, 0x2e, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74,
...
var file_cdriver_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cdriver_proto_goTypes = []interface{}{
	(Nodes_Node_StateE)(0), // 0: driver.Nodes.Node.StateE
	(Chain_StateE)(0),      // 1: driver.Chain.StateE
	(*Nodes)(nil),          // 2: driver.Nodes
	(*Chain)(nil),          // 3: driver.Chain
	(*Nodes_Node)(nil),     // 4: driver.Nodes.Node
	nil,                    // 5: driver.Nodes.Node.CustomInfoEntry
	nil,                    // 6: driver.Chain.CustomInfoEntry
	(*Empty)(nil),          // 7: driver.Empty
}
var file_cdriver_proto_depIdxs = []int32{
	4, // 0: driver.Nodes.Nodes:type_name -> driver.Nodes.Node
	1, // 1: driver.Chain.State:type_name -> driver.Chain.StateE
	6, // 2: driver.Chain.CustomInfo:type_name -> driver.Chain.CustomInfoEntry
	0, // 3: driver.Nodes.Node.State:type_name -> driver.Nodes.Node.StateE
	5, // 4: driver.Nodes.Node.CustomInfo:type_name -> driver.Nodes.Node.CustomInfoEntry
	7, // 5: driver.ChainDriver.InitChain:input_type -> driver.Empty
	7, // 6: driver.ChainDriver.InitNode:input_type -> driver.Empty
	3, // 7: driver.ChainDriver.CreateChainExec:input_type -> driver.Chain
	3, // 8: driver.ChainDriver.InitChain:output_type -> driver.Chain
	2, // 9: driver.ChainDriver.InitNode:output_type -> driver.Nodes
	7, // 10: driver.ChainDriver.CreateChainExec:output_type -> driver.Empty
...
func file_cdriver_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cdriver_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Nodes_Node); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type ChainDriverClient interface {
	...
	// InitNode create node to store
	InitNode(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Nodes, error)
...
func (c *chainDriverClient) InitNode(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Nodes, error) {
	out := new(Nodes)
	err := c.cc.Invoke(ctx, "/driver.ChainDriver/InitNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChainDriverServer interface {
	...
	// InitNode create node to store
	InitNode(context.Context, *Empty) (*Nodes, error)
	// CreateChainExec execute create chain action
...
func (*UnimplementedChainDriverServer) InitNode(context.Context, *Empty) (*Nodes, error) {
...
func _ChainDriver_InitNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChainDriverServer).InitNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/driver.ChainDriver/InitNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainDriverServer).InitNode(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ChainDriver_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InitNode",
			Handler:    _ChainDriver_InitNode_Handler,
		},
		{
