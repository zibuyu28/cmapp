...
var file_mdriver_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x56,
	...
	0x02, 0x38, 0x01, 0x32, 0xeb, 0x02, 0x0a, 0x0d, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x44,
	...
	,
...
var file_mdriver_proto_depIdxs = []int32{
	...
	3, // 6: driver.MachineDriver.InstallMRobot:input_type -> driver.Machine
	3, // 7: driver.MachineDriver.MRoHealthCheck:input_type -> driver.Machine
...
type MachineDriverClient interface {
	...
	InstallMRobot(ctx context.Context, in *Machine, opts ...grpc.CallOption) (*Machine, error)
	// MRoHealthCheck check machine robot install successfully or not
	MRoHealthCheck(ctx context.Context, in *Machine, opts ...grpc.CallOption) (*Machine, error)
	// Exit driver exit
...
func (c *machineDriverClient) InstallMRobot(ctx context.Context, in *Machine, opts ...grpc.CallOption) (*Machine, error) {
	out := new(Machine)
...
func (c *machineDriverClient) MRoHealthCheck(ctx context.Context, in *Machine, opts ...grpc.CallOption) (*Machine, error) {
	out := new(Machine)
...
type MachineDriverServer interface {
	...
	// InstallMRobot install machine robot in this new machine
	InstallMRobot(context.Context, *Machine) (*Machine, error)
	// MRoHealthCheck check machine robot install successfully or not
	MRoHealthCheck(context.Context, *Machine) (*Machine, error)
	// Exit driver exit
...
func (*UnimplementedMachineDriverServer) InstallMRobot(context.Context, *Machine) (*Machine, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InstallMRobot not implemented")
}
func (*UnimplementedMachineDriverServer) MRoHealthCheck(context.Context, *Machine) (*Machine, error) {
...
func _MachineDriver_InstallMRobot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineDriverServer).InstallMRobot(ctx, req.(*Machine))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MachineDriver_MRoHealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineDriverServer).MRoHealthCheck(ctx, req.(*Machine))
	}
	return interceptor(ctx, in, info, handler)
}
