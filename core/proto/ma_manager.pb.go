...
var file_ma_manager_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x72, 0x65, 0x73, 0x22, 0xfa, 0x01, 0x0a, 0x07, 0x4d,
	0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x02, 0x49, 0x44, 0x12, 0x12, 0x0a, 0x04, 0x55, 0x55, 0x49, 0x44, 0x18, 0x02,
	...
	0x12, 0x1a, 0x0a, 0x08, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x49, 0x44, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x08, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x49, 0x44, 0x12, 0x20, 0x0a, 0x0b,
	0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x67, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x0b, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x67, 0x73, 0x12, 0x38,
	0x0a, 0x0a, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x06, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x2e, 0x43, 0x75, 0x73,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x6e, 0x0a, 0x0d, 0x4d, 0x61, 0x63, 0x68, 0x69,
	...
	0x65, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x4d,
	0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12, 0x08, 0x2e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65,
	0x1a, 0x13, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x4d, 0x61, 0x63, 0x68, 0x69,
	0x6e, 0x65, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2e, 0x2f, 0x70, 0x72,
...
var file_ma_manager_proto_depIdxs = []int32{
	...
	1, // 1: MachineManage.ReportInitMachine:input_type -> Machine
	1, // 2: MachineManage.RegisterMachine:input_type -> Machine
	1, // 3: MachineManage.ReportInitMachine:output_type -> Machine
...
type MachineManageClient interface {
	...
	RegisterMachine(ctx context.Context, in *Machine, opts ...grpc.CallOption) (*RegisterMachineRes, error)
}
...
func (c *machineManageClient) RegisterMachine(ctx context.Context, in *Machine, opts ...grpc.CallOption) (*RegisterMachineRes, error) {
...
type MachineManageServer interface {
	...
	// RegisterMachine register machine to core center, maybe to maintain heartbeat, check health status
	RegisterMachine(context.Context, *Machine) (*RegisterMachineRes, error)
}
...
func (*UnimplementedMachineManageServer) RegisterMachine(context.Context, *Machine) (*RegisterMachineRes, error) {
...
func _MachineManage_RegisterMachine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineManageServer).RegisterMachine(ctx, req.(*Machine))
	}
	return interceptor(ctx, in, info, handler)
}
